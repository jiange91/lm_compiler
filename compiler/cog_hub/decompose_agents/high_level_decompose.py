...
from compiler.llm import InputVar, CogLM, StructuredCogLM, OutputFormat
...
def high_level_decompose_kernel(task: str) -> HighLevelDecompose:
    ...
    messages.extend([
        ...
        {"role": "user", "content": "Now please reformat your answer to the JSON format.\n"}
    ])
    new_agents: HighLevelDecompose = format_agent(messages, model_kwargs, inputs={new_agents_input: new_agents_raw})
