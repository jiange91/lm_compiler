...
Example of values in the column: `2007`
            ...
            "HINT": "movie title rated in April 2020 refers to rating_timestamp_utc LIKE '%2020-04-%'; user is a trial list refers to user_trialist = 1;"
        },
        output="No",
...
Example of values in the column: `0`
            ...
            "HINT": "Directed by Buster Keaton refers to director_name; released in 1924 refers to movie_release_year = 1924; paying subscriber refers to user_has_payment_method = 1; rating score of 5 refers to rating_score = 5;"
        },
        output="Yes",
...
Example of values in the column: `Stanley Kubrick`
            ...
            "HINT": "average = AVG(movie_popularity); number of Mubi users who loves the movie refers to movie_popularity;"
        },
        output="Yes",
...
Example of values in the column: `La Antena`
            ...
            "HINT": "Francis Ford Coppola refers to director_name; popularity of more than 1,000 refers to movie_popularity >1000;highest amount of likes that each critic per movie has received refers to MAX(critic_likes)"
        },
        output="Yes",
...
Example of values in the column: `2009-12-18`
            ...
            "HINT": "eligible for trial refers to user_eligible_for_trial = 1"
        },
        output="No",
...
Example of values in the column: `La Antena`
            ...
            "HINT": "Jeannot Szwarc's refers to director_name = 'Jeannot Szwarc'; most popular movie refers to MAX(movie_popularity); average rating score refers to avg(rating_score)"
        },
        output="Yes",
...
Example of values in the column: `5`
            ...
            "HINT": "created a list in the February of 2016 refer to list_creation_date_utc BETWEEN 2/1/2016 and 2/29/2016; eligible for trial refers to user_eligible_for_trial = 1;"
        },
        output="Yes",
...
Example of values in the column: `La Antena`
            """,
            "QUESTION": "List the users who gave the worst rating for movie 'Love Will Tear Us Apart'.",
...
Example of values in the column: `3`
            """,
            "QUESTION": "What is the URL to the user profile image on Mubi of the user who gave the movie id of 1103 a 5 rating score on 4/19/2020?",
            "HINT": "URL to the user profile image on Mubi refers to user_avatar_image_url; 4/19/2020 refers to rating_date_utc;"
        },
        output="Yes",
...
Example of values in the column: `2007`
            ...
            "HINT": "comments refer to critic_comments;"
        },
        output="Yes",
