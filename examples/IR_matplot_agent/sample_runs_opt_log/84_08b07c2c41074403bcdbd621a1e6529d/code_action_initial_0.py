...
temp_gas_liquid = data[0]  # Temperature for gas-liquid boundary
pressure_gas_liquid = data[1]  # Pressure for gas-liquid boundary
temp_solid_liquid = data[2]  # Temperature for solid-liquid boundary
pressure_solid_liquid = data[3]  # Pressure for solid-liquid boundary
...
plt.ylim(0, 25e6)  # 0 to 25 MPa in Pascals
