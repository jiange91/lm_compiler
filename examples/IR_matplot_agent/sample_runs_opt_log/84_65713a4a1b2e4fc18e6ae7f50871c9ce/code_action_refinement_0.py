...
ax.plot(data['Temperature1'], data['Pressure1'], label='Phase Boundary (Solid-Liquid-Gas)', color='blue')
ax.plot(data['Temperature2'], data['Pressure2'], label='Phase Boundary (Solid-Liquid)', color='orange')
