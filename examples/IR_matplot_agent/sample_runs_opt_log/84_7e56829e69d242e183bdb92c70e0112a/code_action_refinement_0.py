...
ax.plot(data[:, 1], data[:, 2], label='Gas-Liquid Boundary', color='blue')
# Assuming columns 3 and 4 are for solid-liquid boundary
ax.plot(data[:, 3], data[:, 4], label='Solid-Liquid Boundary', color='green')

# Mark special points
# Triple point
ax.plot(0.01, 611.657, 'ro', label='Triple Point (273.16 K, 611.657 Pa)')
# Critical point
