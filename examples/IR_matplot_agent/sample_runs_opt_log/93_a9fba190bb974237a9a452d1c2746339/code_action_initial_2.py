...
ax.plot(bond_1_2, zs=0, zdir='y', y=tot_energy, color='red', alpha=0.3, linewidth=2, label='XZ Projection')
ax.plot(zs=0, y=bond_1_14, z=tot_energy, zdir='x', color='green', alpha=0.3, linewidth=2, label='YZ Projection')
