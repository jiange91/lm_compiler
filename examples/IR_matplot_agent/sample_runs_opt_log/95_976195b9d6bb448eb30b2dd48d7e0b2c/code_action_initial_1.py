...
temps_2015_full = temps_2015 + [np.nan] * (12 - len(temps_2015))
...
ax.scatter(angles, temps_2015_full, color='red', label='Highest Temperature (2015)', zorder=5)

# Connect the 2015 data points with a blue curve
ax.plot(angles, temps_2015_full, color='blue', linewidth=2)
