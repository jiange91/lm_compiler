...
# Add circular points for each temperature, slightly offset to prevent alignment along a single radial line
offset_angles = [angle + 0.05 for angle in angles[:-1]]
