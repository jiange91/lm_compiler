...
from utils import print_filesys_struture, run_code, is_run_code_success, get_error_message
...
try_count = 0
def get_run_log(code, workspace):
    global try_count
    file_name = f'code_action_{try_count}.py'
