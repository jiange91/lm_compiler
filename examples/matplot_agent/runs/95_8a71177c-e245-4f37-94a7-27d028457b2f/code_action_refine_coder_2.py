...
offset = 0.1
theta = np.linspace(0, 2 * np.pi, 12, endpoint=False) + offset
...
ax.plot(theta_2015, data_2015['Temperature'], color='blue', marker='o', label='2015 Data', linewidth=2, markersize=8)

# Plot the maximum temperatures for all years as a line
ax.plot(theta, radii, color='orange', label='Monthly Max Temp (2004-2015)', linewidth=2, marker='o', markersize=8)
...
# Set radial limits for better clarity
ax.set_ylim(0, max(radii) + 10)  # Adjust the radial limits
