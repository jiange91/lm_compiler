...
class StormArticlePolishingModule(ArticlePolishingModule):
    ...
    def polish_article_kernel(
        ...
        self.polish_page.engine = lm
        polished_article = self.polish_article(topic, draft_article, remove_duplicate)
        polished_article.dump_article_as_plain_text(f'{topic_dir(topic)}/storm_polished_article.txt')
        polished_article.dump_article_with_refs_as_plain_text(f'{topic_dir(topic)}/storm_article_with_refs.txt')
        return {'polished_article': polished_article}
