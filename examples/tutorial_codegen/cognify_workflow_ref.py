...
cognify_cc_agent = cognify.Model(
    agent_name="cc_agent",
    system_prompt=cc_system_prompt,
    input_variables=[
        cognify.Input(name="incomplete_function"),
    ],
...
cc_agent = cognify.as_runnable(cognify_cc_agent)
...
cognify_rc_agent = cognify.Model(
    agent_name="rc_agent",
    system_prompt=rc_system_prompt,
    input_variables=[
        cognify.Input(name="incomplete_function"),
        cognify.Input(name="completed_code"),
    ],
    output=cognify.OutputLabel(
        name="finalized_code",
        custom_output_format_instructions="Only the function body should be returned, and wrapped in <result> and </result> tags.",
...
rc_agent = cognify.as_runnable(cognify_rc_agent)
