...
rag_workflow.add_edge(hyde_module, knowledge_eval_module)
rag_workflow.add_edge(answer_eval_module, hyde_module)
...
# rag_workflow.add_edge(kalmv_module, direct_hyde_module)
# rag_workflow.add_edge(kalmv_module, answer_compose_module)
# rag_workflow.add_edge(kalmv_module, end_module)

rag_workflow.add_edge(knowledge_eval_module, retrieve_module)
rag_workflow.add_edge(answer_compose_module, answer_grounded_module)
...
rag_workflow.add_edge(answer_grounded_module, end_module)
rag_workflow.add_edge(decompose_module, answer_eval_module)
